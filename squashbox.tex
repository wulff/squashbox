...
\documentclass[final,ebook,10pt,twoside,openright]{memoir}
...
%\stockaiv
%\settrims{3.42cm}{2.88cm} % use this to center the page on the A4 stock
...
\ifpdf
    ...
    plainpages=false,%
    colorlinks=true,%
    linkcolor=peytzorange,%
    urlcolor=peytzorange,%
    pdftex]{hyperref}
\else
	\usepackage{hyperref}
%  \usepackage{memhfixc}
...
\squashboxscreenshot{base/download-02-start.png}{Download the recommended version of Ubuntu}{figdownloadubuntu}
...
% chapter Base system (end)

% ============================================================================
\chapter{Servers} % (fold)
\label{cha:Servers}
\chapterprecis{Install a database server and a web server with support for the \textsc{php} scripting language.}
...
% ============================================================================
\chapter{Development tools} % (fold)
...
% TODO: link to virtual host help doc
...
% chapter Development tools (end)

% ============================================================================
\chapter{Install Drupal} % (fold)
...
% chapter Using NetBeans (end)

% ============================================================================
\chapter{Debugging} % (fold)
\label{cha:Debugging}
\chapterprecis{Speed up your development workflow with the installed tools.}

% chapter Debugging (end)

% ============================================================================
\chapter{Performance testing} % (fold)
...
\squashboxlink{http://drupal/admin?XDEBUG_PROFILE}
...
% chapter Performance testing (end)
